if shared.VapeExecuted then
	...
	local vertextsize = textService:GetTextSize("v"..VERSION, 19, Enum.Font.Gotham, Vector2.new(99999, 99999))
	...
	GuiLibrary["CreateMainWindow"] = function()
		...
		settingsbox2.Font = Enum.Font.Gotham
		settingsbox2.TextXAlignment = Enum.TextXAlignment.Right
		settingsbox2.Text = "Vortex "..VERSION.."  "
		...
		discordbutton.MouseButton1Click:Connect(function()
			...
			task.spawn(function()
				...
				hoverbox3.Font = Enum.Font.Gotham
				...
				setclipboard("https://discord.com/invite/3Pfb7snXMA")
				task.wait(1)
				hoverbox3:Remove()
			end)
		end)
		...
		windowapi["CreateDivider2"] = function(text)
			...
			if text then
				...
				windowapi3["CreateButton2"] = function(argstable)
					...
					toggleframe1.Font = Enum.Font.Gotham
	...
	GuiLibrary["CreateCustomWindow"] = function(argstablemain)
		...
		windowapi["CreateTextBox"] = function(argstable)
			...
			frametext.Font = Enum.Font.Gotham
			...
			framebox.Font = Enum.Font.Gotham
	...
	GuiLibrary["LoadedAnimation"] = function(enabled)
		if enabled then
			--no cache but its ran 1 time so idc
			 GuiLibrary.CreateNotification("Vortex has finished loading", inputService.TouchEnabled and GuiLibrary["GUIKeybind"] == "RightShift" and "Press the button in the top right to open GUI" or "Press "..string.upper(GuiLibrary["GUIKeybind"]).." to open GUI", 5)
		end
	end
